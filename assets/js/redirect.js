...
function redirect(place) {
  if (place == 'yt') { window.open('https://youtube.com/@aRandomMenno', '_blank') }
  ...
  if (place == 'discord') { window.open('https://discord.gg/vRpeAcKruF', '_blank') }
  if (place == 'RiMusic') { window.open('https://github.com/fast4x/RiMusic', '_blank') } 
  if (place == 'ViMusic') { window.open('https://github.com/vfsfitvnm/ViMusic', '_blank') }
  if (place == 'murderdrones') { window.open('https://www.youtube.com/playlist?list=PLHovnlOusNLiJz3sm0d5i2Evwa2LDLdrg', '_blank') }
}
